...
namespace dal_oracle
{
    public class Helper
    {
        ...
        private static OracleConnection getConnectionCC()
        {
        ...
        public static int executeProcedure(string strNombreSP, Dictionary<string, object> _parametros)
        {
            ...
            try
            {
                using (OracleConnection connection = new OracleConnection(ConfigurationManager.ConnectionStrings["SQLConnStr"].ConnectionString))
                {
        ...
        public static IList<Dictionary<string, object>> getObject(string strNombreSP)
        {
            ...
            try
            {
                ...
                using (OracleConnection connection = new OracleConnection(ConfigurationManager.ConnectionStrings["SQLConnStr"].ConnectionString))
                {
                    ...
                    cmd.Parameters.Add("P_RECORDSET", OracleDbType.RefCursor);
                    cmd.Parameters["P_RECORDSET"].Direction = ParameterDirection.Output;
        ...
        public static object getScalar(string strNombreSP, Dictionary<string, object> _parametros, string nombre_parametro_salida)
        {
            ...
            try
            {
                using (OracleConnection connection = new OracleConnection(ConfigurationManager.ConnectionStrings["SQLConnStr"].ConnectionString))
                {
                    ...
                    cmd.Parameters.Add(nombre_parametro_salida, OracleDbType.Int32, ParameterDirection.Output);
